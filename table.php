...
<head>
    ...
    <script>
        ...
        function loadData(page){
            $.post('http://loginautonom.localhost.com/index.php/loadData',{page:pageVar},function(data){
                let dataObjects = JSON.parse(data);

				console.log(dataObjects.pageData.nextPage);
        ...
        $(document).ready(function(e){
            ...
            $(document).on('click','#prev_a',function(e){
                e.preventDefault();
            ...
            $(document).on('click','#next_a',function(e){
                e.preventDefault();
                let page = parseInt($(this).attr('href'));
                loadData(page);
				return false;
